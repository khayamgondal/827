...
funcdef // Used in: decorated, compound_stmt
	...
	{ 
	  ...
	  std::stringstream ss;
	ss << "(\"" << @1.first_line<<":0: '"<< $2 << "'\", " << count << ")" << std::endl;
	output.push(ss.str());
	count = 1; 
	}
	;
...
star_ELIF // Used in: if_stmt, star_ELIF
	: star_ELIF ELIF test COLON suite {count++; }
...
plus_except // Used in: try_stmt, plus_except 
	: plus_except except_clause COLON suite {finallyCount ++; }
